<template>
  <div class="tooltip">
    ...
    <span class="tooltiptext tooltip-top" v-if="!left">{{ text }}</span>
    <span class="tooltiptext-left tooltip-top" v-else>{{ text }}</span>
  </div>
</template>
...
.tooltip {
  ...
  .tooltiptext {
    ...
    box-shadow: 2px 2px 13px 0px var(--tooltip-shadow);
