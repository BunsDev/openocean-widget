    ...
    >
        ...
        <div class="confirm__content">
          <ul class="token">
            <li>
              ...
              <div class="value">
                <img :src="tokenSwapPrev.icon" class="icon" />
                <span>{{ tokenSwapPrev.symbol }}</span>
              </div>
            </li>
            <li>
              <div class="title">
                <span>~$ {{ tokenSwapPrevUsdValue }}</span>
              </div>
              <div class="value">
                <span>{{ tokenSwapPrev.value }}</span>
              </div>
            </li>
          </ul>
          <ul class="token">
            <li>
              ...
              <div class="value">
                <img :src="tokenSwapNext.icon" class="icon" />
                <!-- <a href="#">{{ tokenSwapNext.symbol }}</a> -->
                <span>{{ tokenSwapNext.symbol }}</span>
                <!-- <img src="@/assets/v3/icon-link.svg" class="link" /> -->
              </div>
            </li>
            <li>
              <div class="title">
                <span>~$ {{ tokenSwapNextUsdValue }}</span>
              </div>
              <div class="value">
                <span>{{ tokenSwapNext.value }}</span>
              </div>
            </li>
          </ul>
          <div class="info">
            ...
            <dl>
              ...
              <dd>
                <span>{{ trade.minOutAmount }} {{ tokenSwapNext.symbol }}</span>
              </dd>
            </dl>
            <dl>
              <dt>
      ...
      <div class="dialog-content gas-price" v-if="status === 'gasprice'">
        <div class="gasprice-content">
          <div class="price" v-if="walletType === 'eth'">
            <div
...
export default {
  ...
  data() {
    let displayTolerance =  window.localStorage.getItem(`${state.walletType}_setting_tolerance`) || state.tolerance;
    return {
      status: "confirm",
  ...
  watch: {
    ...
    gas_price(newVal) {
      ...
      window.localStorage.setItem(
        `${this.walletType}_setting_gasPrice`,
        newVal
      );
    },
    tolerance(newVal) {
      ...
      window.localStorage.setItem(
        `${this.walletType}_setting_tolerance`,
        newVal
      );
  ...
  computed: {
    ...
    isCustomGas() {
      return isCustomGas(this.walletType);
    }
  },
  mounted() {
    this.countDown();
