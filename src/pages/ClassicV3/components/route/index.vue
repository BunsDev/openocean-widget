...
.screen-root {
  ...
  ul {
    width: 100%;
    li {
        background-image: linear-gradient(90deg, transparent 25%, var(--background-classic-card) 37%, transparent 63%);
        width: 100%;
        height: 35px;
        list-style: none;
