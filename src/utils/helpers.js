...
export function getApproveAmount (walletType, amount) {
  return window.localStorage.getItem(walletType + '_approve') === '1' ? BigNumber('0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff').toFixed(0, 1) : amount;
}
